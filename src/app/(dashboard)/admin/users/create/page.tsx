        ...
        <div className="max-w-4xl mx-auto pb-20">
            ...
            <form action={formAction} className="space-y-8">
                ...
                <div className="bg-white rounded-[2.5rem] p-8 md:p-10 shadow-xl shadow-slate-200/40 border border-slate-100 relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-primary to-primary-deep" />

                    <div className="flex flex-col md:flex-row gap-8">
                        {/* Mock Photo Uploader / Visual */}
                        <div className="shrink-0 flex flex-col items-center gap-3">
                            <div className="w-32 h-32 rounded-[2rem] bg-slate-100 border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400 hover:bg-slate-50 hover:border-primary/40 hover:text-primary transition-all cursor-pointer">
                        ...
                        <div className="flex-1 space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-5">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-14 rounded-2xl bg-slate-50 border-0 px-5 text-slate-900 font-bold placeholder:text-slate-300 placeholder:font-normal focus:bg-white focus:ring-4 focus:ring-primary/20 focus:text-primary transition-all"
                                    />
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-primary uppercase tracking-wider ml-1 flex items-center gap-1">
                                    National ID / Passport No. <span className="text-red-500">*</span>
                                </label>
                                <div className="relative group">
                                    <CreditCard className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within:text-primary transition-colors" />
                                    <input
                                        name="nationalId"
                                        required
                                        placeholder="e.g. 2488XXXX"
                                        className="w-full h-14 rounded-2xl bg-white border-2 border-slate-100 pl-14 pr-5 text-slate-900 font-bold tracking-wide placeholder:text-slate-300 placeholder:font-normal focus:border-primary focus:ring-0 transition-all shadow-sm group-focus-within:shadow-lg group-focus-within:shadow-primary/10"
                                    />
                                </div>
                            </div>
                        </div>
                ...
                <div className="bg-slate-900 rounded-[2.5rem] p-8 md:p-10 text-white shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row gap-8">
                        ...
                        <div className="flex-1 space-y-6">
                            <div className="flex items-center gap-3 mb-2">
                                <Shield className="w-5 h-5 text-primary/60 md:hidden" />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-14 rounded-2xl bg-white/5 border border-white/10 pl-14 pr-5 text-white font-medium placeholder:text-slate-600 focus:bg-white/10 focus:border-primary focus:ring-0 transition-all"
                                        />
                                    </div>
                                </div>
                ...
                <div className="flex justify-end pt-4">
                    <button
                        type="submit"
                        disabled={isPending}
                        className="px-10 py-4 rounded-2xl bg-primary text-white font-bold text-lg hover:bg-primary-deep hover:shadow-xl hover:shadow-primary/20 hover:-translate-y-1 active:translate-y-0 transition-all flex items-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed"
                    >
