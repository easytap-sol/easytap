...
export default function LandingPage() {
  return (
    <div className="flex flex-col bg-background font-sans text-slate-900 selection:bg-primary/10 selection:text-primary">
      ...
      <main className="relative z-10 w-full overflow-hidden">
        ...
        <section className="pt-20 pb-16 lg:pt-32 lg:pb-24 px-4">
          <div className="container mx-auto max-w-6xl text-center">
            ...
            {/* Trust Badge */}
            <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-white/60 backdrop-blur-sm px-3 py-1 text-xs font-semibold text-primary mb-8 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/signup"
                className="h-12 px-8 rounded-xl bg-primary text-white font-semibold flex items-center gap-2 hover:bg-primary-deep transition-all shadow-lg shadow-primary/25 hover:-translate-y-0.5"
              >
                Get Instant Loan
              ...
              <Link
                href="/login"
                className="h-12 px-8 rounded-xl border border-slate-200 bg-white text-slate-700 font-semibold flex items-center gap-2 hover:bg-slate-50 hover:text-primary transition-all shadow-sm"
              >
                Log In
              </Link>
            </div>
        ...
        <section className="py-12 px-4">
          <div className="container mx-auto max-w-6xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(280px,auto)]">
              ...
              <div className="md:col-span-2 rounded-[2rem] bg-white border border-slate-100 p-8 shadow-xl shadow-slate-200/40 relative overflow-hidden group hover:border-primary/20 transition-colors">
                <div className="relative z-10 max-w-md">
                  ...
                  <Link href="/signup" className="inline-flex items-center text-sm font-bold text-primary hover:underline">
                    Create Customer Account <ChevronRight className="w-4 h-4" />
                  </Link>
                </div>
                {/* Decorative Visual */}
                <div className="absolute top-1/2 right-[-20px] w-64 h-64 bg-primary/5 rounded-full blur-3xl group-hover:bg-primary/10 transition-colors" />
                <div className="absolute right-[-40px] bottom-[-40px] opacity-10 rotate-12 group-hover:rotate-6 transition-transform duration-500">
                  <Smartphone className="w-64 h-64 text-primary-deep" />
                </div>
              </div>
              ...
              <div className="md:col-span-1 rounded-[2rem] bg-slate-900 text-white p-8 relative overflow-hidden group">
                <div className="relative z-10 h-full flex flex-col justify-between">
                  ...
                  <Link href="/login" className="mt-8 inline-flex items-center justify-center w-full h-12 rounded-xl bg-white/10 hover:bg-white/20 text-sm font-semibold transition-colors border border-white/10">
                    Access Dashboard
                  </Link>
                </div>
                {/* Background Gradient */}
                <div className="absolute inset-0 bg-gradient-to-br from-primary-deep/40 via-slate-900 to-slate-900 opacity-50" />
              </div>
        ...
        <section className="py-16 px-4 text-center">
          <div className="container mx-auto max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/signup"
                className="h-12 px-8 rounded-xl bg-primary text-white font-semibold flex items-center gap-2 hover:bg-primary-deep transition-all shadow-lg shadow-primary/20"
              >
                Create Account
                <ArrowRight className="h-4 w-4" />
              </Link>
