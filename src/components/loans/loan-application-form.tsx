                ...
                <div className="space-y-6">
                  <div className="relative">
                    ...
                    <input
                      ...
                      min="100"
                      step="100"
                      className="w-full h-16 rounded-2xl border-2 border-slate-200 bg-slate-50 pl-20 pr-4 text-3xl font-bold text-slate-900 placeholder:text-slate-400 focus:border-primary focus:ring-4 focus:ring-primary/20 focus:outline-none transition-all"
                    />
                  </div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {[1000, 5000, 10000, 20000, 50000].map((quickAmount) => (
                      <button
                        ...
                        className="px-4 py-2 rounded-xl border border-slate-200 bg-white text-slate-700 font-bold hover:bg-slate-50 hover:border-primary transition-colors"
                      >
                ...
                <div className="pt-6 border-t border-slate-100">
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full h-12 bg-primary text-white font-bold rounded-2xl hover:bg-primary-deep shadow-lg shadow-primary/20 transition-all duration-300 flex items-center justify-center gap-3"
                    >
                      {isPending ? (
                        <>
