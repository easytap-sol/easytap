          ...
          <div className="absolute top-16 left-0 right-0 bg-white border-b shadow-lg md:hidden">
            <div className="container mx-auto px-4 py-6">
              <div className="flex flex-col gap-4">
                <Link href="#features" className="py-3 px-4 rounded-lg hover:bg-muted transition-colors font-medium">
                  Features
                </Link>
                <Link href="#how-it-works" className="py-3 px-4 rounded-lg hover:bg-muted transition-colors font-medium">
                  How it Works
                </Link>
                <Link href="#pricing" className="py-3 px-4 rounded-lg hover:bg-muted transition-colors font-medium">
                  Rates & Fees
                </Link>
                <Link href="/login" className="py-3 px-4 rounded-lg hover:bg-muted transition-colors font-medium flex items-center gap-2">
                  <Smartphone className="h-4 w-4" />
                  Customer Login
                </Link>
                <Link 
                  href="/register" 
                  className="mt-2 inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-primary to-primary/90 px-5 py-3 font-semibold text-white shadow-lg shadow-primary/25"
                >
                  Get Instant Loan
                  <ArrowRight className="h-4 w-4" />
                </Link>
